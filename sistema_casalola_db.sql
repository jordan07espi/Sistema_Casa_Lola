...
--
-- Servidor: db
-- Tiempo de generación: 05-12-2025 a las 23:02:28
...
INSERT INTO `clientes` (`id_cliente`, `cedula`, `nombre`, `email`, `telefono`, `activo`, `fecha_registro`) VALUES
(1, '2350637217', 'JORDAN ESPINOSA', NULL, '0986780565', 0, '2025-11-24 18:30:41'),
(2, '1714309844', 'LUIS ESPINOSA', NULL, '0986780565', 1, '2025-11-24 18:30:58'),
(3, '2350637217', 'JORDAN ESPINOSA', NULL, '0986780565', 1, '2025-11-24 18:39:33'),
(4, '2300533193', 'HECTOR CEDEÑO', '', '0988838348', 1, '2025-11-24 21:30:01'),
(5, '1712396199', 'ENMA TIPAN', NULL, '0982826252', 1, '2025-11-25 03:47:56');
...
(12, '2025_44', 3, 1, '2025-12-05 21:52:33', '2025-12-05', '21:51:00', 23.00, 'Pendiente', '', NULL, 0, NULL),
(13, '2025_443', 3, 1, '2025-12-05 21:53:10', '2025-12-05', '21:51:00', 23.00, 'Pendiente', '', NULL, 0, NULL),
(14, '2025_55', 4, 1, '2025-12-05 22:04:27', '2025-12-05', '22:04:00', 400.00, 'Pendiente', '', NULL, 0, NULL),
(15, '2025_444', 2, 1, '2025-12-05 22:05:59', '2025-12-05', '22:05:00', 60.00, 'Pendiente', '', NULL, 0, NULL),
(16, '2025_100', 5, 1, '2025-12-05 22:07:12', '2025-12-05', '22:06:00', 115.00, 'Pendiente', '', NULL, 0, NULL),
(17, '2025_FF', 3, 1, '2025-12-05 22:52:08', '2025-12-05', '22:51:00', 115.00, 'Pendiente', '', NULL, 0, NULL);
...
(18, 12, '2025_44', 'Pendiente', 1),
(19, 12, '2025_33', 'Pendiente', 4),
(20, 12, '2025_344', 'Pendiente', 4),
(21, 13, '2025_443', 'Pendiente', 1),
(22, 13, '2025_3', 'Pendiente', 4),
(23, 13, '2025_32', 'Pendiente', 4),
(24, 14, '2025_55', 'Pendiente', 1),
(25, 14, '2025_2', 'Pendiente', 2),
(26, 14, '2025_6', 'Pendiente', 2),
(27, 14, '2025_43', 'Pendiente', 2),
(28, 15, '2025_444', 'Pendiente', 7),
(29, 16, '2025_100', 'Pendiente', 1),
(30, 17, '2025_FF', 'Pendiente', 1);
...
--
ALTER TABLE `detalles_pedido`
  MODIFY `id_detalle` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;
...
--
ALTER TABLE `pedidos`
  MODIFY `id_pedido` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT de la tabla `pedidos_tillos`
--
ALTER TABLE `pedidos_tillos`
  MODIFY `id_tillo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
