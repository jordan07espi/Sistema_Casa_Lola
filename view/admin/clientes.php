...
<div class="bg-white rounded-lg shadow-md overflow-hidden">
    <div class="p-4 border-b border-gray-100 bg-gray-50 flex justify-between items-center">
        ...
        <div class="relative">
            <input type="text" id="buscadorCliente" placeholder="Buscar cliente..." class="pl-9 pr-4 py-2 border rounded-lg text-sm focus:ring-orange-500 focus:border-orange-500">
...
<div id="clienteModal" class="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center hidden z-50 backdrop-blur-sm">
    <div class="bg-white rounded-lg shadow-2xl w-full max-w-md transform transition-all scale-100">
        <div class="bg-gray-900 text-white px-6 py-4 rounded-t-lg flex justify-between items-center">
            ...
            <button id="closeModal" class="text-gray-400 hover:text-white transition text-2xl">&times;</button>
        </div>
        ...
        <form id="clienteForm" class="p-6">
            ...
            <div class="mb-4">
                <label class="block text-gray-700 font-medium mb-2">Cédula / RUC</label>
                <input type="text" name="cedula" id="cedula" 
                    class="w-full border-gray-300 rounded-lg focus:ring-orange-500 focus:border-orange-500 px-4 py-2 border transition-colors" 
                    placeholder="Ej: 1720..." maxlength="10">
                <p id="errorCedula" class="text-red-500 text-xs mt-1 hidden font-semibold"></p>
            </div>
            ...
            <div class="mb-6">
                ...
                <input type="text" name="telefono" id="telefono" 
                    class="w-full border-gray-300 rounded-lg focus:ring-orange-500 focus:border-orange-500 px-4 py-2 border transition-colors" 
                    placeholder="Ej: 099..." maxlength="10">
